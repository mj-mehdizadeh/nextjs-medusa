  ...
  return (
    <div className="w-full">
      <div className="mb-8 flex flex-col gap-y-4">
        <h1 className="text-2xl-semi">حساب کاربری</h1>
        <p className="text-base-regular">
          مشاهده و به روز رسانی اطلاعات حساب کاربری، از جمله نام، ایمیل،
          و شماره تلفن همچنین می توانید آدرس صورتحساب خود را به روز کنید یا رمز عبور خود را تغییر دهید.
        </p>
      </div>
