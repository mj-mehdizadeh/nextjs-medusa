...
const Hero = ({ settings: {title, description, buttonText, buttonLink, imgUrl} }: Section<HeroProps>) => {
  return (
    <div className="w-full h-[90vh] relative">
      <div className="text-white absolute inset-0 z-10 flex flex-col justify-center items-center text-center small:text-right small:justify-end small:items-start small:p-32">
